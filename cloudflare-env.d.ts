/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e701f55d9c2d232ce86d66f3ceafe82b)
// Runtime types generated with workerd@1.20250617.0 2025-07-07 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		TMDB_API_KEY: string;
		WORKER_SELF_REFERENCE: Fetcher /* orchestrapi */;
		AGENT_PROXY_WORKER: Fetcher /* orchestrapi-agent-proxy-worker */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "TMDB_API_KEY">> {}
}
