/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d663f2d9c663f2d4d70471bc9d4d3f9a)
// Runtime types generated with workerd@1.20250617.0 2025-03-25 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		TMDB_API_KEY: string;
		OrchestrApiAgent: DurableObjectNamespace<import("./custom-worker").OrchestrApiAgent>;
